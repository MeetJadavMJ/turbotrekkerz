                    ...
                    <form action="vlogin_code.php" method="post">
                        <div class="main-w3layouts-sectns ">
                            <div class="w3-btm-spc form-text2 p-0">
                                ...
                                <input type="text" name="Address" id="" placeholder="Enter Your Address Here">
                                ...
                                <input type="text" name="city" id="" placeholder="Enter Your city Here">
                                <input type="text" name="contact" id="" placeholder="Enter Your contact Here"><br>
